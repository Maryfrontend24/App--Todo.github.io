 ...
 import {formatDistanceToNow, interval} from 'date-fns';
 ...
 function Task({ task, onToggleCompleted, removeTask, editTask, text }) {
     ...
     const [secondsAddTask, setSecondsAddTask] = useState(0);
     ...
     useEffect(() => {
         ...
         const startTimerAddTask = () => {
             intervalId = setInterval(() => {
                 setSecondsAddTask(prevSeconds => prevSeconds + 1);
             }, updateInterval);
         };

         const stopTimerAddTask= () => {
         ...
         <li className='li'>
             <div className='view'>
              ...
              <span>
                ...
                created {formatDistanceToNow(new Date(date), {
                                 includeSeconds: true,
                                 addSuffix: true,
                             })}
                                 </span>
